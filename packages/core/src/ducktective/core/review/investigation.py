...
class StepKind(StrEnum):
    ...
    STAGE = "stage"
    """Чем прогон занят прямо сейчас: собирает окружение, читает файл, сводит.

    Пишется узлами графа, а не ревьюером. Без этого лента молчит первые
    минуты — ровно столько собирается окружение на большом диффе, — и человек
    смотрит на счётчик, не понимая, идёт работа или встала.
    """
